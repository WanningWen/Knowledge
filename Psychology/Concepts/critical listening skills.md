---
created: 2025-12-31T19:53:11-08:00
tags:
  - Terms
  - Science/Psychology
aliases:
---
## Why we need good listening:
to connect #1 and #4 of Gordon's model of listening 
![[Gordon's Model of Listening]]
### How:
1. **simple reflection**: brief restatement of what the person said
	- help conversation keep going
	- validation and checkin
2. **complex reflections**:
	- educated guess about something beneath what was said
		- "leap" move the conversation forward
	- direct/reinforce elements of the conversation
#### What NOT to do: questions
why: unlike questions, reflections
- encourage continuation of the same conversation 
- validating
- accurate
# Methodology
## Nonverbal listening
...
> [!NOTE] Restating a message, but usually with fewer words. Where possible try and get more to the point.  
### Purpose:  
1. To test your understanding of what you heard.  
2. To communicate that you are trying to understand what is being said
...
S: I really think he is a very nice guy. He’s so thoughtful, sensitive, and kind. He calls me a lot. 
He’s fun to go out with.  
X: You like him very much, then.  
## Clarifying  
> [!NOTE] Process of bringing vague material into sharper focus.  
### Purpose:  
...
## Perception Checking  
> [!NOTE] Request for ==verification== of your perceptions.  
### Purpose:  
3. To give and receive feedback  
4. To check out your assumptions  
### e.g.  
...
## Summarizing  
> [!NOTE] pulling together, organizing, and integrating the major aspects
> Pay attention to various ==themes and emotional overtones==. Pout key ideas and feelings into ==broad statements==. 
